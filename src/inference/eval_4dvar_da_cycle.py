...
from src.inference.inference import assim_cycle_4dvar
...
def assimilate_cycle_inference(data_dir,
    ...
    for i, ic in enumerate(ics):
        seq_real, seq_assim, seq_rmse, seq_acc = assim_cycle_4dvar(ic,
                                                                    eval_dataset,
                                                                    B_half,
                                                                    R_inv,
                                                                    1,
    ...
    for i in range(val_rmse.shape[-1]):
        ...
        # print(f"MAE of {var_idx[i]} is： {np.mean(val_mae, axis=0)[:, i]}")
...
def prepare_parser():
    ...
    parser.add_argument(
        ...
        default='/public/home/wangwuxing01/research/fundation/output/da_cycle'
    )
