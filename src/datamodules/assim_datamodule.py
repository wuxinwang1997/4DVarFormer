...
class AssimDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            self.data_train = Assim(self.hparams.data_dir, split='train', modelname=self.hparams.modelname)
            self.data_val = Assim(self.hparams.data_dir, split='val', modelname=self.hparams.modelname)
            self.data_test = Assim(self.hparams.data_dir, split='test', modelname=self.hparams.modelname)
