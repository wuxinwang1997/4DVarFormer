...
class AFNONet(nn.Module):
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            Block(dim=embed_dim, mlp_ratio=mlp_ratio, drop=drop_rate, drop_path=dpr[i], norm_layer=norm_layer, double_skip=double_skip,
...
if __name__ == "__main__":
    model = AFNONet(img_size=(160, 160), patch_size=(4,4), in_chans=3, out_chans=10)
